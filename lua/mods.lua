...
Intro
	...
	:ExschMod(10.0, 14, 100, 0, 'reverse0', 'end', Tweens.outelastic)
	:ExschMod(10.5, 14, 100, 0, 'reverse1', 'end', Tweens.outelastic)
	:ExschMod(11.0, 14, 100, 0, 'reverse2', 'end', Tweens.outelastic)
	:ExschMod(11.5, 14, 100, 0, 'reverse3', 'end', Tweens.outelastic)
